...
const ThirdScreen = () => {
    return (
        <Stack3.Navigator >
            <Stack3.Screen name="History" component={History} options={{ headerTitleAlign: 'center', headerLeft: () => (<Text style={{ marginLeft: -20, marginTop: -30 }}><HeaderL /></Text>), headerRight: () => (<Text><HeaderR /></Text>) }} />
